...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        ...
        if (epoch == epochs):
           ...
           log_fname = "simclr_log.csv"
           if len(glob("simclr_log.csv")) == 0:
              f = open(log_fname, "w")
              f.write("date,time,feature_dim,temp,k,batch_size,epochs,nshots,train_size,acc1\n")
              f.close()
           
           dte = datetime.datetime.now().strftime("%m-%d-%Y")
           tme = datetime.datetime.now().strftime("%H:%M:%S")
           f = open(log_fname, "a")
           f.write("{},{},{},{},{},{},{},{},{},{:.3f}\n".format(dte, tme, feature_dim, temperature, k, batch_size, epochs, nshots, train_size, best_acc))
           f.close()
